...
import com.project.adminklikkerja.adapter.TeacherProfileAdapter
...
class TeacherProfileActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        fab_add_class.setOnClickListener {
            ...
            intent.putExtra(UtilsConstant.USERNAME, mName)
            intent.putExtra(UtilsConstant.EMAIL, mEmail)
            intent.putExtra(IS_TEACHER, true)
            startActivity(intent)
        }

        val pageAdapter = TeacherProfileAdapter(this)
