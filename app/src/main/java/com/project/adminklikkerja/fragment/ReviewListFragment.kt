...
import com.project.adminklikkerja.adapter.ReviewListAdapter
import com.project.adminklikkerja.model.ReviewModel
import com.project.adminklikkerja.utils.UtilsConstant
import kotlinx.android.synthetic.main.fragment_students.swipe_refresh
...
class ReviewListFragment : Fragment() {
    ...
    private fun requestData() {
        ...
        val adapter = context?.let { ReviewListAdapter(options) }
