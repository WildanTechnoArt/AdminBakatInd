...
import com.project.adminklikkerja.adapter.FirestoreTeacherNotApprovedAdapter
import com.project.adminklikkerja.model.TeacherModel
import com.project.adminklikkerja.presenter.TeacherApprovedPresenter
import com.project.adminklikkerja.view.TeacherApprovedView
import kotlinx.android.synthetic.main.fragment_students.*

class TeacherNotApprovedFragment : Fragment(), TeacherApprovedView.View {

    private lateinit var presenter: TeacherApprovedView.Presenter
    ...
    private fun prepare(view: View) {
        presenter = TeacherApprovedPresenter(view.context, this)
    ...
    private fun searchData(query: String) {
        ...
        val adapter = FirestoreTeacherNotApprovedAdapter(options, presenter)
